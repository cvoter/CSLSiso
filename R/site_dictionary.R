...
#'                         NA)}
#' \item{elev_m}{elevation of the lake above mean sea level (m)}
#' \item{lat_deg}{latitude of the lake (decimal degrees)}
#' \item{long_deg}{longitude of the lake (decimal degrees)}
#' }
#'
"site_dictionary"
