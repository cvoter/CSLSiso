...
plot_ET <- ggplot(data = melted_evap, 
...
lake_levels <- cslsdata::lake_levels[["Pleasant"]]
lake_levels$lake <- "Pleasant"
tmp_lake_levels <- cslsdata::lake_levels[["Plainfield"]]
tmp_lake_levels$lake <- "Plainfield"
lake_levels <- rbind(lake_levels, tmp_lake_levels)
tmp_lake_levels <- cslsdata::lake_levels[["Long"]]
tmp_lake_levels$lake <- "Long"
lake_levels <- rbind(lake_levels, tmp_lake_levels)
