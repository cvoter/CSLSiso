...
```{r iso_evap, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 2.5}
inputs_plot("d18O_evap", expression(delta^18*'O'), geom_type = "point")
```
...
```{r GWin, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3}
inputs_plot("GWin_m3", expression(Groundwater~Inflow~(m^{3})), inputs_only = FALSE)
```
...
```{r GWout, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3}
inputs_plot("GWout_m3", expression(Groundwater~Outflow~(m^{3})), inputs_only = FALSE)
```
...
```{r psnt_monthly, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 5}
plot_balance("Pleasant", runall_csls_budget("Pleasant"))
```

### Long Lake - Monthly Balance
```{r long_monthly, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 5}
plot_balance("Long", runall_csls_budget("Long"))
```

### Plainfield Lake - Monthly Balance
```{r pfl_monthly, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 5}
plot_balance("Plainfield", runall_csls_budget("Plainfield"))
```
...
for (lake in c("Pleasant", "Long", "Plainfield")) {
  budget <- runall_csls_budget(lake, annual = TRUE)
  budget$lake <- lake
  annual_h2o_bal <- rbind(annual_h2o_bal, budget)
}
plot_annual_bal(annual_h2o_bal)
plot_annual_bal(annual_h2o_bal, as_pcnt = TRUE)
```
