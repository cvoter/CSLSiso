...
h2o_bal_default   <- subset(monthly_h2o_bal, is.na(GWout) == FALSE)

# Static GW Wells --------------------------------------------------------------
monthly_isotopes  <- get_monthly_isotopes(isotopes, site_dictionary,
                                          static_wells = TRUE, lake_levels, 
                                          gw_levels, Xday = 7, 
                                          static_lake = FALSE)
monthly_isotopes  <- get_monthly_d18O_evap(monthly_weather, monthly_lst, monthly_isotopes)
monthly_h2o_bal   <- get_monthly_h2o_bal(monthly_weather, monthly_isotopes, monthly_dV, month_info)
h2o_bal_gw        <- subset(monthly_h2o_bal, is.na(GWout) == FALSE)
...
monthly_isotopes  <- get_monthly_d18O_evap(monthly_weather, monthly_lst, monthly_isotopes)
monthly_h2o_bal   <- get_monthly_h2o_bal(monthly_weather, monthly_isotopes, monthly_dV, month_info)
h2o_bal_lake      <- subset(monthly_h2o_bal, is.na(GWout) == FALSE)
...
monthly_isotopes  <- get_monthly_d18O_evap(monthly_weather, monthly_lst, monthly_isotopes)
monthly_h2o_bal   <- get_monthly_h2o_bal(monthly_weather, monthly_isotopes, monthly_dV, month_info)
h2o_bal_both      <- subset(monthly_h2o_bal, is.na(GWout) == FALSE)
...
plot_sensitivity <- ggplot(data = h2o_bal_melt) +
                    ...
                    theme_bw() + 
                    labs(x = "", y = "GW Inflow (mm)", title = "Plainfield Lake") +
                    guides(fill = FALSE) +
...
plot_sensitivity <- ggplot(data = h2o_bal_melt) +
                    ...
                    scale_y_continuous(expand = c(0,0)) +
                    theme_bw() + 
                    labs(x = "", y = "GW Inflow (mm)", title = "Long Lake") +
                    guides(fill = FALSE) +
                    theme(text = element_text(family = "Segoe UI Semilight"))
plot_sensitivity
