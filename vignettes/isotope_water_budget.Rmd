...
calculated based on Gibson et al. (2016). $k$ represents the seasonality of a
location, varying from 0.5 for highly seasonal climates to 1.0 for non-seasonal
climates. Here, $k$ defaults to 0.8.
\begin{align}
\tag{9}
